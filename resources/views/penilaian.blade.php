                ...
                <form id="form-penilaian" action="{{ route('penilaian.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" name="jenis" id="jenis-penilaian">
                            ...
                            <option value="prestasi" {{ old('jenis') == 'prestasi' ? 'selected' : '' }}>Prestasi
                            </option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="keterangan" class="form-input" id="keterangan-penilaian"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="poin" class="form-input" id="poin-penilaian"
                               value="{{ old('poin') }}">
                        @error('poin')
                        <small style="color: red;">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal" class="form-input" id="tanggal-penilaian"
                               value="{{ old('tanggal') }}">
                        @error('tanggal')
                        <small style="color: red;">{{ $message }}</small>
                        @enderror
